...
msg = [];
	...
	$("#editPasswordId").attr("data-href","adminEditPassword");
	$("#faceRegisterId").attr("data-href","adminFaceRegister");
	$("#aaa").attr("style","display:none;");//隐藏di
}else{
	msg = [];
	var json='[{"id": "1","name": "贴吧","icon": null,"url": "","parentId": "","childs": [{"id": "11","name": "精品菜系","icon": "/xingxing.png","url": "meal","parentId": "4","childs": []},{"id": "12","name": "购物车","icon": "/xingxing.png","url": "cart","parentId": "4","childs": []},{"id": "14","name": "我的订单","icon": "/xingxing.png","url": "myOrders","parentId": "4","childs": []},{"id": "16","name": "个人设置","icon": "/xingxing.png","url": "editUser","parentId": "4","childs": []}]}]';
	// jquery的方法
	var jsonObj = $.parseJSON(json)
	...
	$("#editPasswordId").attr("data-href","userEditPassword");
	$("#faceRegisterId").attr("data-href","usersFaceRegister");
	$("#mapId").attr("data-href","map");
